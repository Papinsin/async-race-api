...
const Cars = (car: CarsInterface): JSX.Element => {
  return (
    <div
      ...
      title={car.name}
    >
      {car.selected && <ModifyCars carID={car.id}></ModifyCars>}
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col car_setting_Btns">
          <button
            className="bg-rose-950/40 text-rose-400 p-1 disabled:opacity-30 disabled:pointer-events-none"
            disabled={car.state}
      ...
      >
        ...
        >
          ...
          <rect x="12" y="9" width="76" height="30" rx="8" fill={car.color || 'red'} />
          <rect x="42" y="14" width="22" height="20" rx="4" fill="#0f172a" />
          <rect x="45" y="16" width="6" height="16" rx="1.5" fill="#ffffff" opacity="0.3" />
